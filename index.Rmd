...
To analyse data in R, you need both R and RStudio. These are _different_ programmes. Think of R as the software that executes our commands and RStudio as the interface between us and R that makes interacting with R a much more pleasant experience. RStudio has many nifty features, like providing code suggestions and keyboard shortcuts that make writing code much faster and easier. It also reminds you to install packages if it realises that you're trying to load a package that you've not installed. So... For the sake of your sanity, I strongly recommend you download both programmes!

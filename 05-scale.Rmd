...
MVS <- MVS %>%
  mutate(MVS_avg = rowMeans(across(c(mvs_1:mvs_8, mvs_9r)))) # calculate the average MVS score across the 9 items and call the average MVS_avg
...
Congratulations on completing this tutorial! You're now ready to do the next assignment! Proceed to the [next section](#tha3)!
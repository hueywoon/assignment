...
# NOTE. The order in which you enter the values for expectedprop should be the same as that for observedfreq
...
# Get the observed frequencies for each cell and save it as observedfreq1
observedfreq1 <- table(div_and_mar_only$marital_status, div_and_mar_only$have_children)

...
In this class, I typically use .csv files. To import .csv files, we can use the `read_csv()` function from the `readr` package in `tidyverse`. 
...
Reference: [http://genomicsclass.github.io/book/pages/dplyr_tutorial.html](http://genomicsclass.github.io/book/pages/dplyr_tutorial.html)